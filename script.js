...
document.querySelector("#crudTable tbody").innerHTML = html;
 ...
 function updateData(index){
    // Submit button will be hidden and update button will show for updating of Data in local storage......
...
if(validateForm() == true){
    ...
    document.getElementById("email").value = "";
       ...
       // Update button will be hidden and Submit button will show......
